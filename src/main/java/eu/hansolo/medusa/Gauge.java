...
public class Gauge extends Control {
    ...
    private void init() {
        ...
        originalMajorTickSpace              = 10;
        originalMinorTickSpace              = 1;
        originalThreshold                   = _threshold;
        lastCall                            = Instant.now();
    ...
    public void setMajorTickSpace(final double SPACE) {
        if (null == majorTickSpace) {
            ...
            if ( !updatingAutoscaleExtrema ) {
                originalMajorTickSpace = _majorTickSpace;
                if ( isAutoScale() ) {
                    calcAutoScale();
                }
            }
    ...
    public void setMinorTickSpace(final double SPACE) {
        if (null == minorTickSpace) {
            ...
            if ( !updatingAutoscaleExtrema ) {
                originalMinorTickSpace = _minorTickSpace;
                if ( isAutoScale() ) {
                    calcAutoScale();
                }
            }
